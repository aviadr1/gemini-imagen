# Standalone installer wrapper for gemini-imagen (Windows)
#
...
#   iwr -useb https://raw.githubusercontent.com/aviadr1/gemini-imagen/main/scripts/install.ps1 | iex

$ErrorActionPreference = "Stop"

# Configuration
$InstallerUrl = "https://raw.githubusercontent.com/aviadr1/gemini-imagen/main/scripts/install.py"
$TempInstaller = "$env:TEMP\gemini-imagen-install.py"
...
try {
    Write-Host ""
    Write-Host "gemini-imagen Installer" -ForegroundColor White -BackgroundColor Black
    Write-Host ""
